            ...
            try
            {
                if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity target)
                {
                    ...
                    if (target.Attributes.Contains("ts_totalpreparationtime"))
                    {
                        ...
                        localContext.Trace("ts_totalpreparationtime changed. New value: {0}", totalPreparationTime);
                        anyFieldChanged = true;
                    }
                    if (target.Attributes.Contains("ts_totalrepanddoctime"))
                    {
                        ...
                        localContext.Trace("ts_totalrepanddoctime changed. New value: {0}", totalRepAndDocTime);
                        anyFieldChanged = true;
                    }
                    if (target.Attributes.Contains("ts_totalconductoversight"))
                    {
                        ...
                        localContext.Trace("ts_totalconductoversight changed. New value: {0}", totalConductOversight);
                        anyFieldChanged = true;
                    }
                    if (target.Attributes.Contains("ts_totaltraveltime"))
                    {
                        ...
                        localContext.Trace("ts_totaltraveltime changed. New value: {0}", totaltravelTime);
                        anyFieldChanged = true;
                    }
