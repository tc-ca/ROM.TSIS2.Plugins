    ...
    public class PostOperation_AccountUpdate : PluginBase
    {
        ...
        protected override void ExecuteCrmPlugin(LocalPluginContext localContext)
        {
            ...
            try
            {
                ...
                {
                    localContext.Trace("Target is Account entity.");
                    ...
                    {
                        localContext.Trace("Account name fields have been updated.");
                        ...
                        localContext.Trace("Account ID: {0}", accountId);
                        ...
                        {
                            localContext.Trace("Retrieve Operations that belong to the Account.");
                            ...
                            localContext.Trace("Found {0} operations associated with Account.", operations.Entities.Count);
                    ...
                    {
                        localContext.Trace("Account name fields were not updated, skipping processing.");
                    }
                }
                else
                {
                    localContext.Trace("Target entity is not Account, skipping processing.");
                }
            }
            catch (Exception e)
            {
                localContext.TraceWithContext("Error occurred: {0}", e.Message);
